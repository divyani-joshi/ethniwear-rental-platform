...
export default function ManageItems({ setIsAuthenticated, adminName }) {
  ...
  const openEdit = (item) => {
    setEditing(item);
    setForm({
      category_id: String(item.category_id || item.category?._id || ""),
      name: item.name,
    ...
    setImgFile(null);
    setPreview(item.image ? `${BACKEND}${item.image}` : null);
    setModal(true);
  };
      ...
      <div className="row mb-4">
        <div className="col-12">
          ...
          <p className="text-sm text-muted mb-0">
            Add and manage ethnic clothing available for rental.
          </p>
        </div>
      </div>
          ...
          <tr key={item._id}>
            ...
            <td>
              <p className="text-xs font-weight-bold mb-0 text-primary">
                ₹{item.price}
                <span className="text-secondary font-weight-normal">/day</span>
              </p>
            </td>
            <td>
              <span
                className={`badge badge-sm ${item.status === "Available" ? "badge-success" : "badge-warning"}`}
              >
                {item.status}
              </span>
            </td>
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title font-weight-bolder">
                  {editing ? "Edit Clothing Item" : "Add Clothing Item"}
                </h5>
                <button
                  type="button"
                  className="btn-close"
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      ...
                      <textarea
                        ...
                        placeholder="Describe the outfit, fabric, embroidery, occasion..."
                        required
                      />
                    </div>
                    <div className="col-md-6">
