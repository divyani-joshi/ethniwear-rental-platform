          ...
          <div className="card h-100">
            <div className="card-body p-3">
              <div className="text-center mt-3 mb-4">
                ...
                <h5 className="mb-1 mt-3 font-weight-bolder">
                  {profile?.name}
                </h5>
                ...
                {[
                  ...
                  >
                    <div className="d-flex align-items-center">
                      <i
                        className={`fa ${item.icon} text-sm me-3`}
                        style={{ color: "#344767", width: 16 }}
                      />
                      <div>
              ...
              {imgFile && (
                <button
                  className="btn bg-gradient-primary w-100 mt-3 btn-sm"
                  onClick={handleSave}
                  disabled={saving}
                >
          ...
          <div className="card h-100">
            <div className="card-header pb-0">
              <ul className="nav nav-tabs" role="tablist">
                {[
                  { k: "info", label: "Account Info" },
                  { k: "password", label: "Change Password" },
                ].map((t) => (
                  <li className="nav-item" key={t.k}>
                    <button
                      className={`nav-link ${tab === t.k ? "active" : ""}`}
                      onClick={() => setTab(t.k)}
                      style={{
                        border: "none",
                        background: "none",
            ...
            <div className="card-body pt-3">
              ...
              {tab === "password" && (
                <form onSubmit={handlePass}>
                  <div
                    className="alert alert-warning text-sm mb-4"
                    role="alert"
                  >
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      ...
                      {passForm.confirm && (
                        <small
                          className={`mt-1 d-block ${passForm.newPassword === passForm.confirm ? "text-success" : "text-danger"}`}
                        >
                          <i
                            className={`fa ${passForm.newPassword === passForm.confirm ? "fa-check" : "fa-times"} me-1`}
                          />
