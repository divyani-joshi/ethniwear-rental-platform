...
export const getToken = () => localStorage.getItem("ew_admin_token")
export const setToken = (t) => localStorage.setItem("ew_admin_token", t)
export const removeToken = () => localStorage.removeItem("ew_admin_token")
