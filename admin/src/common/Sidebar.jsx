...
const menuGroups = [
  {
    cap: "General",
    items: [{ to: "/", icon: "fa-chart-pie", label: "Dashboard" }],
  },
  {
    cap: "Inventory",
    items: [
  ...
  {
    cap: "Account",
    items: [{ to: "/profile", icon: "fa-user-circle", label: "My Profile" }],
  },
];
  ...
  return (
    ...
    >
      <div className="sidenav-header">
        ...
        />
        <Link
          className="navbar-brand m-0 d-flex align-items-center gap-2 px-4 py-3"
          to="/"
        >
