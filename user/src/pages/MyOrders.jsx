...
export default function MyOrders() {
  ...
  const handlePay = async (order) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: "INR",
        name: "EthniWear",
        description: `${order.item?.name} – ${order.rental_days} day(s)`,
        order_id: rzpId,
  ...
  const handleReturnRequest = async (orderId) => {
    try {
      const token = localStorage.getItem("ew_user_token");
  ...
  const handlePenaltyPayment = async (order) => {
    try {
      ...
      const options = {
        ...
        handler: async function (payment) {
          try {
            ...
            toast.error("Penalty verification failed");
          }
        },
      ...
      toast.error(error.response?.data?.message || "Penalty payment failed");
    }
  };
    ...
    <div style={{ background: "#121212", minHeight: "80vh" }}>
      ...
      >
        <div className="container">
          ...
          <p style={{ color: "#595959", fontSize: 13, margin: 0 }}>
            ...
            › <span style={{ color: "var(--primary-color)" }}>My Orders</span>
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "80px 0" }}>
            ...
            <p style={{ color: "#595959", marginBottom: 24 }}>
              Start by exploring our ethnic clothing collection!
            </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {orders.map((o) => (
              <div
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.borderColor = "rgba(227,226,49,.2)")
                }
                onMouseLeave={(e) =>
                  ...
                  <div className="col-md-5">
                    ...
                    >
                      ...
                      >
                        <span
                          style={{
                            background: `${statusColor[o.status] || "#595959"}18`,
                            color: statusColor[o.status] || "#595959",
                            border: `1px solid ${statusColor[o.status] || "#595959"}30`,
                            borderRadius: 4,
                            padding: "3px 10px",
                            fontSize: 12,
                            fontWeight: 700,
                        ...
                        <span
                          style={{
                            background: `${payColor[o.payment_status] || "#595959"}18`,
                            color: payColor[o.payment_status] || "#595959",
                            border: `1px solid ${payColor[o.payment_status] || "#595959"}30`,
                            borderRadius: 4,
                            padding: "3px 10px",
                            fontSize: 12,
                            fontWeight: 700,
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#A0A0A0", fontSize: 14, marginBottom: 24 }}>
              Your reserved size will be released. This action cannot be undone.
            </p>
      ...
      {feedbackModal && (
        ...
        >
          ...
          >
            <h4 style={{ color: "#fff", fontWeight: 700, marginBottom: 4 }}>
              Leave a Review
            </h4>
            <p style={{ color: "#A0A0A0", fontSize: 13, marginBottom: 24 }}>
              How was your experience with{" "}
              <strong style={{ color: "var(--primary-color)" }}>
                {feedbackModal.item?.name}
              </strong>
              ?
            </p>
