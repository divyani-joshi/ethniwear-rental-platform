    ...
    <div style={{ background:"#121212",minHeight:"80vh" }}>
      ...
      <div style={{ background:"#0d0d0d",borderBottom:"1px solid rgba(227,226,49,.1)",padding:"48px 0" }}>
        ...
        <div className="container text-center">
          ...
          <h1 style={{ color:"#fff",fontFamily:"Outfit, sans-serif",fontWeight:900,fontSize:"clamp(1.8rem,4vw,3rem)",marginBottom:8 }}>
            Customer <span style={{ color:"var(--primary-color)" }}>Reviews</span>
          </h1>

          <p style={{ color:"#595959",fontSize:13 }}>
            <Link to="/" style={{ color:"#595959",textDecoration:"none" }}>
              Home
            </Link> › <span style={{ color:"var(--primary-color)" }}>Reviews</span>
          </p>
      ...
      <div className="container" style={{ padding:"48px 0" }}>
        ...
        {!loading && feedbacks.length > 0 && (
          ...
          <div style={{ background:"#1a1a1a",border:"1px solid rgba(227,226,49,.15)",borderRadius:14,padding:28,marginBottom:40 }}>

            <div className="text-center">

              <div style={{ fontSize:56,fontWeight:900,color:"var(--primary-color)" }}>
                {avg}
              </div>
...
<h5 style={{ color:"#fff",marginBottom:10 }}>
  {f.user?.name || "User"}
                  ...
                  <p style={{ color:"#A0A0A0",fontSize:14,fontStyle:"italic",lineHeight:1.7 }}>
                    "{f.feedback}"
                  </p>
  ...
  >
    ...
    {orders && orders.length > 0 ? (
      ...
      orders.map((order,index)=>(
        ...
        >
          {order.item?.name || `Order #${order._id.toString().slice(-5)}`} | ₹{order.total_amount}
        </option>
